...
//
//		char temp_choice='A';
//		Sort_Menu_choice = -1;//记录进入主菜单之后输入的选项
//		while (Sort_Menu_choice < 0 || Sort_Menu_choice>9)
//		{
//			cin >> Sort_Menu_choice;
//			switch (Sort_Menu_choice)
//			{
//			case 1:Sort_SubMenu(); break;
//			case 2:Sort_SubMenu(); break;
//			case 3:Sort_SubMenu(); break;
//			case 4:Sort_SubMenu(); break;
//			case 5:Sort_SubMenu(); break;
//			case 6:Sort_SubMenu(); break;
//			case 7:Sort_SubMenu(); break;
//			case 8:Sort_SubMenu(); break;
//			case 9:Sort_SubMenu(); break;
//			case 0:Main_Menu();
//			default:cout << "您的输入有误，请重新输入！" << endl;
//			}
//		}
